...
import 'package:atividade_quiz/quiz.dart';
            ...
            child: ListView(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Image.asset('assets/pata-animal.png', width: 50, height: 50),
                    ...
                    child: Card(
                      ...
                      child: Column(
                        children: [
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Image.asset('assets/pantera.png', width: 50, height: 50),
                          ),
                          Text('Mostre seu conhecimento \nterrestre',
                  ...
                  child: Card(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Image.asset('assets/morcegos.png', width: 50, height: 50),
                        ),
                        Text('Mostre seu conhecimento \naéreo',
                          style: GoogleFonts.indieFlower(fontSize: 16, fontWeight: FontWeight.bold)),
                        ListTile(
